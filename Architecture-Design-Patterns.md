...
### MVC в клиент-серверных приложениях
...
**Boundaries** содержат в себе функционал, касающийся интерфейса системы (системного окружения), то есть отвечают за связь системы с окружающим миром.
...
Хотим сделать функционал отправки электронных сообщений, доступный в обоих UI.
