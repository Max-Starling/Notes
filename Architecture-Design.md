...
И
Классам следует достигать полиморфизма и переиспользования кода за счёт их композиции.

Причины придерживаться этого принципа:
* *Переиспользуемость кода*. Множественное наследование запрещено во множестве языков программирования из-за ромбовидной проблемы (diamond problem): два родительских класса могут иметь метод с одинаковым названием, какой из них применится? Есть возможность наследоваться только от одного класса (в большинстве языков программирования множественное наследование запрещено из-за) озицию можно использовать неограниченное количество раз, а наследо
* *Тестирование*.
* *Инкапсуляция*. аследование нарушает принцип инкапсуляции, так как дочерний класс зависит от поведения своего родительского класса и изменение последнего повлечёт за собой непосредственное изменение дочернего класса.
