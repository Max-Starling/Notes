...
Композиция и агрегация являются формами ассоциации.

Примеры:
* У человека только одна жизнь (один к одному).
* В книжном магазине много книг (один ко многим).
* В нашем соревновании множество участников, но только один победитель. (многие-к-одному)
* В этом городе есть десятки ресторанов, в каждом из которых есть по-своему интересные блюда (многие-ко многим).
