...
http://localhost:3000
https://github.com/Max-Starling?tab=overview&from=2018-12-01&to=2018-12-31
```
...
Браузер получает введённую пользователем строку и разбивает её на лексемы, затем пытается найти среди них . 
