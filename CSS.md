...
*Преимущества AMCSS*
* *Модульность* кода и *изолированность модулей* друг от друга.  
* *Простая специфичность*. (*БЭМ* — *классы*, *специфичность*: *10*; *AMCSS* — *атрибуты*, *специфичность*: *1*).  
* Решена проблема с *длинными названиями* классов, свойственная БЭМ.
```html
<div class="select__option select__option--first select__option--selected"> // БЭМ
