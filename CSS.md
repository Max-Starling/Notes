...
Блочные элементы могут содержать как строчные, так и блочные элементы.
...
*Строчные (встроенные) элементы* используются для *форматирования текстовых фрагментов* (кроме area, img). 

Строчный элемент
Например, элементы span или strong. Они не генерируют переводов строк вокруг себя и являются потомками блочных. Это означает, что можно помещать строковые элементы в блочные, но не наоборот.

Строчные элементы могут содержать только данные и другие строчные элементы. Строчные элементы не могут содержать блочные элементы.
...
Если *псевдо-класс* или *псевдо-элемент* применяются *ко всем элементам*, то рекомендуется не пропускать *универсальный селектор* **\***, поскольку иначе может возникнуть путаница.  
