...
- [Основы CSS](#основы-css)
  - [Синтаксис CSS](#синтаксис-css)
    - [At-rules](#at-rules)
  - [Основные типы элементов в CSS](#основные-типы-элементов-в-css)
    - [Блочные и строчные элементы](#блочные-и-строчные-элементы)
    - [Замещаемые и незамещаемые элементы](#замещаемые-и-незамещаемые-элементы)
  - [CSS Box Model](#css-box-model)
  - [Типы отношений элементов в CSS](#типы-отношений-элементов-в-css)
  - [Селекторы в СSS](#селекторы-в-сss)
    - [Простые селекторы](#простые-селекторы)
    - [Комбинаторы (составные селекторы)](#комбинаторы-составные-селекторы)
    - [Псевдоклассы и псевдоэлементы](#псевдоклассы-и-псевдоэлементы)
    - [Применение CSS-селекторов в JavaScript (Selectors API)](#применение-css-селекторов-в-javascript-selectors-api)
  - [Специфичность селекторов](#специфичность-селекторов)
    - [Правила специфичности](#правила-специфичности)
  - [Некоторые правила хорошего тона при написании CSS](#некоторые-правила-хорошего-тона-при-написании-css)
    - [Общие правила](#общие-правила)
    - [Почему лучше избегать использования селекторов по id и использовать селекторы по классу](#почему-лучше-избегать-использования-селекторов-по-id-и-использовать-селекторы-по-классу)
    - [Скорость выполнения селекторов браузерами](#скорость-выполнения-селекторов-браузерами)
- [Подходы к написанию CSS](#подходы-к-написанию-css)
  - [БЭМ](#бэм)
    - [БЭМ в CSS](#бэм-в-css)
    - [БЭМ в SCSS](#бэм-в-scss)
    - [Преимущества и недостатки БЭМ](#преимущества-и-недостатки-бэм)
    - [Пример использования *БЭМ* с *React*](#пример-использования-бэм-с-react)
  - [OOCSS](#oocss)
    - [Первое правило подхода OOCSS: разделение Структуры и Оформления](#первое-правило-подхода-oocss-разделение-структуры-и-оформления)
    - [Второе правило подхода OOCSS: разделение Контейнера и Контента](#второе-правило-подхода-oocss-разделение-контейнера-и-контента)
    - [OOCSS в CSS](#oocss-%d0%b2-css)
    - [OOCSS в SCSS](#oocss-%d0%b2-scss)
    - [Преимущества и недостатки OOCSS](#преимущества-и-недостатки-oocss)
  - [SMACSS](#smacss)
  - [Atomic CSS](#atomic-css)
    - [Atomic CSS и CSS](#atomic-css-и-css)
    - [Преимущества и недостатки Atomic CSS](#преимущества-и-недостатки-atomic-css)
  - [AMCSS](#amcss)
    - [Синтаксис AMCSS](#синтаксис-amcss)
    - [AMCSS и CSS](#amcss-и-css)
    - [Преимущества и недостатки AMCSS](#преимущества-и-недостатки-amcss)
...
* **Наборы правил**, или проще: **правило** (ruleset, rule).
* **At-правило** (at-rule).
...
```
При обработке стилевых правил браузеры пользуются определённым *приоритетом*.  
Чем *ниже по списку*, тем *выше приоритет*:
* стили браузера
* стили автора
* стили пользователя
* стили автора с добавлением !important
* стили пользователя с добавлением !important
