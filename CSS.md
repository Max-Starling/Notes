...
**Вендор префиксы** (vendor prefixes), **браузерные префиксы** добавляют поддержку эксперементальных или тестируемых браузерных технологий, которые на данный момент не входят в стандарт.
