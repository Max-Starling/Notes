...
.article { padding: 16px !important; } /* применится это правило */
```

### Некоторые правила хорошего тона при написании CSS

Как можно заметить, правила специфичности не так сложны, если рассмотреть конкретный селектор. Но если речь идёт о файлах с тысячами селекторов, очень трудно с ходу рассчитать, какой стиль будет применён в итоге.
