...
*Исключением* является элемент *p*, относящийся к *блочным* элементам, но он *не должен содержать* внутри себя *блочные* элементы (в том числе и p).
...
Также есть *блочно-строчные* элементы, которые обладают смешанной характеристикой: являются встроенным, но для них можно задавать поля, отступы, ширину и высоту.
