...
**Модули атрибутов для CSS** (Attribute Modules for CSS, AMCSS) — технология, использующая атрибуты и их значения вместо классов.
...
Одной из идей подхода является исправление проблемы БЭМ со слишком длинными названиями классов.
```html
<!-- /* БЭМ * / -->
