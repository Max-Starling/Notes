...
**Символом** (англ. character) называют *условный знак*, *обозначающий* одно или несколько *понятий*.

Примеры *символов*: `“z”`, `“#”`, `“7”`.

Например, *символ* `“+”` *обозначает сложение в арифметике*, *начало номера телефона*, а так же другие понятия.
...
### Сообщение
Самым распространённым *способом передачи информации* является *передача сообщения*.
