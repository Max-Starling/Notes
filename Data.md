...
## Кодирование символов и набор символов
...
**Кодированием** (англ. encoding) называют *процесс преобразования последовательности символов одного алфавита* в *последовательность символов другого алфавита*.
...
**Набором символов** (англ. character set, charset) называют *таблицу*, которая *каждому символу* *одного алфавита* *ставит* в *соответствие один или несколько символов другого алфавита*. *Существует* так же *устаревшее понятие* “**кодировка**” (англ. encoding) с *тем же определением*, которое *иногда используется* как *синоним* для *набора символов*.
