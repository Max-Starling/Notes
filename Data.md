...
**Битовые перации** *принимают* в качестве *операндов последовательности бит* (или *операнды приводятся* к *последовательностям бит*) и *возвращают последовательность бит*.

<!--
**Битовые операции** *предназначены* для работы с *последовательностями бит*. 
-->

Такими *двоичными последовательностями* являются `01110111`, `1110` и другие.
