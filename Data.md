...
*Размер представления* любого *символа* в *первых кодировках не превышал одного байта*. Наиболее яркими *примерами таких кодировок выступают семибитная* **кодировка ANSII** (англ. American Standard Code for Information Interchange) и *восьмибитная* (*однобайтовая*) 
**расширенная кодировка ANSII** (англ. Extended ANSII). *Последняя* является *стандартом* в *языке C* и часто *встречается* при работе с языком *C++*.
