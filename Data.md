...
* **Инкремент** (англ. increment, inc) - *увеличение значения на единицу*. *Обозначение инкремента числа* `x`: `x++` или `++x`. *Пример инкремента числа* `x`: `++6 = 7`.
* **Декремент** (англ. decrement, dec) - *увеличение значения на единицу*. *Обозначение инкремента числа* `x`: `x--` или `--x`. *Пример инкремента числа* `x`: `--4 = 3`.
* **Модуль** (англ. absolute value, abs) - *значение числа без* учёта *знака*. *Обозначение модуля числа* `x`: `|x|` или `abs(x)`. *Пример модуля числа* `x`: `|-5| = 5`.

#### Бинарные операции над целыми числами
* **Сложение** (англ. addition, add).
* **Разность** (англ. subtraction, sub).
* **Умножение** (англ. multiplication, mul).
* **Деление** (англ. division, div).
* **Возведение числа в степень** (англ. power, pow).
* **Взятие квадратного корня** (англ. square root, sqrt).
