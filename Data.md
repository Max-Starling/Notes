...
Например, *символом* `“+”` *обозначают сложение* в *математике* и *номер телефона*, *символ* `“z”` *представляет* собой *последнюю букву английского алфавита*, а *символ* `“7”` *представляет* собой *арабскую цифру*.
...
При *кодировании представление символов алфавита* `A` *символами алфавита* `B` называют **кодом** (англ. code), а *если алфавит* `B` *состоит лишь* из *нулей и единиц*, то есть `B = { 0, 1 }`, то такое *представление* называют **бинарным кодом** (англ. binary code).
