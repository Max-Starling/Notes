...
**Массивом символов** называют *способ представления* в *памяти компьютера* **строки длины `n`** как **массива** из **`n + 1` элементов**, в котором *символы строки* занимают *индексы от* `1` *до* `n`, а *элемент* с *нулевым индексом хранит длину строки* (*количество символов*) или *размер строки* (*количество байт*).
...
Длина строки | Символ (код символа)

-->

Индексы элементов массива | 0 (длина строки) | 1 | 2 | 3 | 4 | 5
:--: | :--: | :--: | :--: | :--: | :--: | :--:
Строка `"Notes"` | 5 | `'N'` | `'o'` | `'t'` | `'e'` | `'s'`
Строка `"море"` | 4 | `'м'` | `'о'` | `'р'` | `'е'` | -
