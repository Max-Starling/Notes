...
* **Инкремент** (англ. **inc**rement) - *увеличение значения на единицу*. *Обозначение инкремента числа* `x`: `x++` или `++x`. *Пример инкремента числа*: `++6 = 7`.
* **Декремент** (англ. **dec**rement) - *увеличение значения на единицу*. *Обозначение инкремента числа* `x`: `x--` или `--x`. *Пример инкремента числа*: `--4 = 3`.
* **Модуль** (англ. **abs**olute value) - *значение числа без* учёта *знака*. *Обозначение модуля числа* `x`: `|x|` или `abs(x)`. *Пример модуля числа*: `|-5| = 5`.
* **Отрицание** (англ. **neg**ation) - *смена знака числа* на *противоположный*. *Обозначение отрицания числа* `x`: `-x` или `neg(x)`. *Пример отрицания числа* `8`: `-8`, *отрицания числа* `-2`: `2`.

#### Бинарные операции над целыми числами
* **Сложение** (англ. **add**ition).
* **Разность** (англ. **sub**traction).
* **Умножение** (англ. **mul**tiplication).
* **Деление** (англ. **div**ision).
* **Возведение числа в степень** (англ. **pow**er).
* **Взятие квадратного корня** (англ. **sq**uare **r**oo**t**, sqrt).
