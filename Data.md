...
**Строковым типом** (англ. string type) называют *тип данных*, *каждое значение* которого *представляет* собой *последовательность символов* некоторого *алфавита*. 
...
<!--
Например, можно представить слово `Notes` как
Символы
Коды символов
Биты
