...
* **Битовое “И”** (англ. bitwise “AND”) *принимает две двоичные последовательности* и производит *логическое “И”* для *каждой пары бит последовательностей*. *Обозначение логического “И”* для *последовательностей* `x` и `y`: `x AND y`.
<!--
```
10101110 AND
```
...
x | 10000001 | 10101010 | 11100001
:--: | :--: | :--: | :--:
y | 00000111 | 01010101 | 00010000
NOT x | 10000111 | 11111111 | 11110001
