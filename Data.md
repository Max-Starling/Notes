...
*Ранее* мы *выяснили*, что *один байт* можно *представить 256*-ю *способами расстановки* *нулей* и *единиц*, а это значит, что *однобайтовая кодировка* позволяла *закодировать не более 256 символов*.
