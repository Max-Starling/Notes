...
*Математически код* можно *представить* как *функцию* `f(x) = y`, где `x` - *упорядоченный набор (кортеж) символов алфавита* `A`, а `y` - *упорядоченный набор (кортеж) символов алфавита* `B`.

Например, `f('b') = 11011011`.

<!--
При *кодировании информации*
-->

**Набором символов** (англ. character set, charset) называют *таблицу*, которая *каждому символу* *одного алфавита* *ставит* в *соответствие один или несколько символов другого алфавита*. 
