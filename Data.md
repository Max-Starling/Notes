...
Вообще говоря, *математическое множество целых чисел* `Z` *бесконечно*. Но, *из-за ограниченности ресурсов*, *компьютер не способен хранить* что-либо *бесконечное*, поэтому *множество целочисленных значений конечно* в *компьютерном представлении* и *ограничивается сверху* и *снизу максимальным* и *минимальным значениями*. Например, 
