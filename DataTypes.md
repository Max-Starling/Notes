...
**Полуслово** (англ. **halfword**), **короткое целое** (англ. **short**) | `2 байта` (`16 бит`) | *Беззнаковый*: *от* `0` *до* `2^16 - 1 = 65535`, *знаковый*: *от* `-2^15 = -32768` до `2^15 - 1 = 32767`
**Слово** (англ. **word**), **длинное целое** (англ. **long**) | `4 байта` (`32 бит`) | *Беззнаковый*: *от* `0` *до* `2^32 - 1`, *знаковый*: *от* `-2^31` до `2^31 - 1`
**Длинное слово** (англ. **longword**),  **двойное слово** (англ. **doubleword**), (англ. **long long**) | `8 байт` (`64 бит`) | *Беззнаковый*: *от* `0` *до* `2^64 - 1`, *знаковый*: *от* `-2^63` до `2^63 - 1`
