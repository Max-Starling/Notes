...
*Далее* будем рассматривать *операции над числами* **`n1 = m1 • 10^e1`** и **`n2 = m2 • 10^e2`**.

#### Сложение и разность

*Сложение* и *разность чисел с плавающей точкой требуют совпадения порядков* чисел **`e = e1 = e2`**. Если *порядки не совпадают*, то *необходимо перенести точку* в одной из *мажорант* так, чтобы *порядки совпали*.

**Сложение** (англ. addition) **чисел `n1` и `n2`** осуществляется по *формуле*:  
**`n1 + n2 = (m1 + m2) • 10^e`**.
...
**Разность** (англ. subtraction) **чисел `n1` и `n2`** осуществляется по *формуле*:  
**`n1 - n2 = (m1 - m2) • 10^e`**.
...
**Умножение** (англ. multiplication) **чисел `n1` и `n2`** осуществляется по *формуле*:  
**`n1 • n2 = (m1 • m2) • 10^(e1 + e2)`**.
...
**Деление** (англ. division) **чисел `n1` и `n2`** осуществляется по *формуле*:  
**`n1 ÷ n2 = (m1 ÷ m2) • 10^(e1 - e2)`**.
