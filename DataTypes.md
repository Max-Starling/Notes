...
## Размер целочисленных значений, краткое и длинное целые числа
...
*Размер целочисленного значения задаётся* либо *языком программирования*, либо *зависит* от *размера машинного слова*, который *зависит* от *архитектуры процессора* (CPU).

Достаточно часто *целому числу выделяется* `4 байта`.
