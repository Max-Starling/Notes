...
## Размер целочисленных значений, короткое и длинное целые числа
...
#### Диапазон целых чисел в зависимости от размера
...
**Короткое целое** (англ. short integer) 

**Длинное целое** (англ. long integer)


В *различных языках программирования размеры короткого* и *длинного целого отличаются*.
