...
Например, при *представлении целого числа со знаком одним байтом*: *выделяется* `1 бит` на *знак* и *остаётся* `7 бит` на само *число*. Таким образом, *одним байтом* могут быть *представлены целые числа со знаком от* `-128` *до* `127`.
