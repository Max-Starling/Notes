...
Таким образом, *уникальность опирается не на наличие объекта* в *текущий момент времени*, а на *особенности (природу) класса объектов*, которые *допускают возможность появления нового объекта* в *любой момент времени*. *Неплохими идентификаторами сотрудника компании* могут стать: *номер паспорта* или *трудовой книги*, *рабочий email* или *номер телефона* и так далее (все они *не могут повториться у двух сотрудников*).
