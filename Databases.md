...
*Отношение удобно представлять* в виде **таблицы**, *столбцы* которой *соответствуют атрибутам заголовка*, а *строки* - *кортежам тела отношения*. Поэтому *отношения* часто *называют таблицами*.
