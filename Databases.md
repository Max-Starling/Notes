...
*Ключи используются* для *идентификации кортежей*.
...
**Потенциальным ключом** называют *подмножество атрибутов отношения*, удовлетворяющее требованиям уникальности и минимальности (несократимости). 

Поскольку все кортежи в отношении по определению уникальны, в любом отношении должен существовать по крайней мере один потенциальный ключ. 
