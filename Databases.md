...
- [Инструкции SQL](#инструкции-sql)
  - [Инструкции для работы с базой данных](#работа-с-базой-данных)
  - [Создание таблицы с помощью CREATE](#создание-таблицы)
  - [Вставка в таблицу с помощью INSERT](#вставка-в-таблицу)
