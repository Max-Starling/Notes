...
:--: | :--: | :--: | :--:
erk | Доброй ночи | cde | fkh
jht | И тебе | fkh | cde

## Связи между отношениями
- [О связях между отношениями](#о-связях-между-отношениями)
- [Один к одному (1:1)](#один-к-одному)
- [Один ко многим (1:M)](#один-ко-многим)
- [Многие ко многим (M:M)](#многие-ко-многим)
- [Ссылочная целостность](#ссылочная-целостность)

### О связях между отношениями

Связь между двумя и более отношениями устанавливается при помощи внешних ключей.
...
В одном диалоге много сообщений.
...
Чтобы *обеспечить ссылочную целостность*, необходимо при *изменении значения потенциального ключа* `CK` *заменить значения всех ссылающихся* на него *внешних ключей* `FK` или *отменять операцию изменения*, если *замена невозможна*. 
