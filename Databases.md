...
**Данные** (англ. data) - это *форма представления информации* в *цифровом виде*. *Информация* - это *смысл*, который *содержится* в *данных*. В некотором смысле, *информация* является *абстракцией*, а *данные* являются её *реализацией*.
...
**Сообщением** (англ. message)  называют *упорядоченный набор элементов* (*символов*) *с повторениями*, *составленный* из *элементов* некоторого *алфавита* `A`.
