...
**Проекция отношения `R`** - унарная операция над отношением `R`, результатом которой является новое отношение `R'`, содержащее в своём заголовке лишь некоторые из атрибутов отношения `R`, а в своём теле - все кортежи отношения `R` с исключением тех значений атрибутов, атрибуты которых не вошли в проекцию. 

Графически, проекция отношения `R` - это выборка столбцов таблицы.

Если при исключении атрибутов и их значений возникают повторяющиеся кортежи, то они удаляются из результата.
