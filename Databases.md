...
## Об отношении и кортеже в теории множеств

Напомним, что **множество** - это совокупность объектов, обладающих схожими признаками. Эти объекты называются элементами множества.


Например, множество женских имён: `N = { Ася, Сара, Рози }`, множество дат регистрации: `{ 2019 2020 }`.


Пусть имеется несколько множеств, каждое из которых содержит некоторое конечное число элементов. 

 Объектами могут быть любые реальные или  строки, числа, даты и так далее).

**Кортежем** называют упорядоченный набор элементов
