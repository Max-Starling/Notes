...
*Атрибут объекта* обычно *состоит* из **имени атрибута** (name) и **значения атрибута** (value). *Значение атрибута принадлежит* некоторому *типу данных*.
...
Говоря простыми словами, *заголовок отношения состоит* из *атрибутов* и *соответствующих* им *типов данных*.
...
Простыми словами, *тело отношения* - это *множество кортежей*, *содержащих значения атрибутов*.
