...
Примеры *множеств*: *множество женских имён*: `N = { Ася, Сара, Рози }`, *множество ролей*: `R = { user, admin }`, *множество дат регистрации*: `D = { 2019 2020 }`.
...
Поскольку *отношение* так же *является множеством*, его *свойства вытекают* из *свойств множеств*:  
1) *Отношение не может содержать* двух и более *одинаковых кортежей*.  
