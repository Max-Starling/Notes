...
- [Множества и их элементы](#множества-и-элементы)
...
**Индикаторной функцией** (англ. indicator function), **индикатором** или **характеристической функцией** (англ. characteristic function) называют *функцию* `
