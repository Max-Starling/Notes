...
U+44 — D
```
То есть есть другое множество — *множество уникальных номеров*, с которым у множества символов установлено *взаимно однозначное соответствие*.
...
**Кодовая точка, позиция кода** (code point, code position) — любой элемент из *множества уникальных номеров*.  
