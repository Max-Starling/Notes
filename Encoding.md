...
Чтобы не путать с 10 c/c, в 16 с/c к числу обычно добавляют `0x`.

Двоичные цифры 0 и 1 называют **битами**, они взаимоисключаемы: 0 - ложь, 1 - истина.

**Байт** — последовательность из 8 бит, его можно представить в виде шестнадцатеричного числа.
```css
00000000 = 0 (0x0)
10110011 = B3 (0xB3)
11111111 = FF (0xFF)
...
Пример: множество символов `A B C D` используются в английском и немецком языках.
