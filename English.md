...
```
* В вопросительной и отрицательной формах не используются вспомогательные глаголы `do`, `does`.
```css
– ~Should~ he go there? /* Следует ли ему идти туда? */
– He ~needn't~ do it.
– ~May~ I come in? /* Можно мне войти? */
```
* Не имеют временных форм (кроме `can` – `could`, `may` – `might`, `have to` и `to be`) и страдательного загола.
