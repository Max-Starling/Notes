...
* **Изменённое** (modified). Локально изменённая версия файла.
* **Подготовленное** (staged). Локально изменённая версия файла, помеченная для включения в следующий коммит.
* **Зафиксированное** (committed). Сохранённая в истории Git версия файла.
