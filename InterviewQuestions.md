...
- Какие проблемы встречаются при многопоточности? Что вы знаете о состоянии гонки? Что происходит, когда два потока обращаются к одному ресурсу одновременно? Какие есть способы решения проблемы?
...
- Какие паттерны тестирования вы знаете? Что такое заглушка?
