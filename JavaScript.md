...
При **слабой** (нестрогой) **типизации** автоматически выполняется множество неявных преобразований даже при условии неоднозначности преобразования или возможности потери точности.
