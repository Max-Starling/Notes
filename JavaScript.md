...
Для отслеживания мутаций раньше был доступен метод `Object.observe()`. Сейчас его запрктили, но добавили другие способы отслеживать мутации.
...
**Proxy** — ещё один встроенный объект, позволяющий отлавливать все операции над объектом, к которому он привязан, и как-то реагировать на эти операции.
