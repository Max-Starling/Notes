...
Понятие **синхронное программирования** подразумевает синхронное (последовательное) выполнение операций в порядке их указания в коде. Следующая операция не может запуститься, пока не завершится текущая.
...
Понятие **асинхронной** (asyncronous, async) **операции** подразумевает, что *операция выполнится в будущем, не прямо сейчас*.

**Асинхронная операция ввода-вывода** — операция ввода-вывода, позволяющая во время своего выполнения продолжить выполнение других задач. То есть выполнение асинхронной операции ввода-вывода не препятствует запуску следующей операции.
