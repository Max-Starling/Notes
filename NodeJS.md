...
* **Опрос** (Poll) — *ожадание новых колбэков* (новых таймеров, ожидающих колбэков) и их выполнение. Здесь выполняется большинство *колбэков завершённых операции ввода-вывода* (I/O).
