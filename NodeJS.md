...
**Событийно-ориентированное программирование** (Event-driven programming) — парадигма, в которой выполнение программы определяется событиями. 

В ответ на событие программа производит действие. В контексте JavaScript: вызывает заданную функцию обратного вызова.
