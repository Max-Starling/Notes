...
Операции, которые не блокируют основной поток, называют **неблокирующими операциями ввода-вывода** (Non-blocking I/O). К ним относятся арифметические операции, логирование и прочее. *Асинхронные операции* так же являются *неблокирующими*.
