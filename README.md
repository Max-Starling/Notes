...
- [Динамическая сборка промпта](./AI-Engineering.md#динамическая-сборка-промпта)
...
- [Структурированный вывод и генерация документов](./AI-Engineering.md#структурированный-вывод-и-генерация-документов)
...
### [Рендеринг веб-приложений](./Rendering.md)
...
- [Что происходит между кликом и картинкой](./Rendering.md#что-происходит-между-кликом-и-картинкой)
- [Рендеринг на клиенте (CSR)](./Rendering.md#рендеринг-на-клиенте-csr)
- [Рендеринг на сервере (SSR)](./Rendering.md#рендеринг-на-сервере-ssr)
- [Гидратация](./Rendering.md#гидратация)
- [Статическая генерация (SSG)](./Rendering.md#статическая-генерация-ssg)
- [Инкрементальная регенерация (ISR)](./Rendering.md#инкрементальная-регенерация-isr)
- [Потоковый рендеринг](./Rendering.md#потоковый-рендеринг)
- [Серверные компоненты](./Rendering.md#серверные-компоненты)
- [Острова (Islands Architecture)](./Rendering.md#острова-islands-architecture)
- [Возобновляемость (Resumability)](./Rendering.md#возобновляемость-resumability)
- [Что выбирать](./Rendering.md#что-выбирать)
