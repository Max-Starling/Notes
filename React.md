...
Если говорить простыми словами, то жизненный цикл компонента не сильно отличается от жизненного цикла живого существа. 

Живое существо рождается, изменяется со временем и умирает. Компонент создаётся, изменяется и удаляется из памяти, когда в нём нет больше не обходимости.
