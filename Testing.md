...
**Ручное тестирование** — прямое взаимодействие QA-инженера с приложением. QA ищет неисправности и недостатки, а затем информирует о них программиста.
...
* *Стоимость*. Ручное тестирование обходится дешевле на небольших проектах.
* *Отсутствие затрат на написание кода*. Это важно при быстром внедрении новой функциональности.
...
Серия автоматизированных тестов позволяет протестировать программное обеспечение значительно быстрее.
...
**Автоматизированное тестирование** — написание кода для тестов. Методика автоматизированного тестирования позволяет создать ожидаемый сценарий, а затем сравнить его с реальным и указать расхождения.

### Плюсы автоматизированного тестирования
* *Возможность моделирование большой нагрузки*. Приближено к реальной ситуации использования приложения.
* *Скорость выполнения*. Ручное тестирование – это долгий и ресурсоемкий процесс, в то время как код для сценария пишется один раз.
* *Переиспользуемость*. Код автотестов может быть использован неоднократно, особенно при внедрении новой функциональности.
* *Отсутствие человеческого фактора*. Качественно написанный тест

### Минусы автоматизированного тестирования
* Отсутствие тестирования глазами пользователя. Не все неисправности можно покрыть автотестами. которые могут быть не покрыты автотестами. Отсутствие возможности тестирования цвета, дизайна и эргономики. Этот пункт не является первостепенным, но может значительно повлиять на качество продукта.
* Отсутствие обратной связи. Автоматизированные тесты не предоставляют обратную связь относительно качества продукта, а лишь выполняют запрограммированные сценарии.
