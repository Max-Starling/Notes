...
**Acceptance TDD** (ATDD) - разработчка через приёмочные тесты. Подход близок к TDD, но отличается акцентом на совместную разработку тестировщиком, заказчиком и программистом.

ATDD включает в себя приёмочные тесты, но эти тесты пишутся до написания кода.  
