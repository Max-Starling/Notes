...
Кодом описывается ожидаемый сценарий, затем при запуске тестов он сравнивается с реальным и программа указывает расхождения.
...
* *Отсутствие человеческого фактора*. Код не может забыть что-то проверить, он каждый раз последовательно проверяет действия.
...
* *Стоимость*. Автоматизированное тестирование затратно на небольних проектах.
