...
Интерфейс в TypeScript является виртуальной структурой: он существует только в контексте языка. Компилятор при помощи интерфейсов проводит проверку типов, а затем переводит код в JavaScript, куда интерфейс не попадает.
