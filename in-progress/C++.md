...
**Указатель** (pointer) — переменная, значением которой является адрес ячейки памяти, то есть указатель ссылается на начала какого-то блока данных из области памяти.
