...
* Вторая часть *содержит* сам *объект сожалений*. Эта часть *всегда* находится в *прошедшем времени* (`Past Simple`).
...
##### Примеры
```js
- I wish I had a dog // Как бы мне хотелось, чтобы у меня была собака (но её нет)
