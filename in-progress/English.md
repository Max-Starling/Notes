...
**Условное предложение** (англ. `Conditional sentense`) - это сложное предложение, которое состоит из двух частей: **условия** и **следствия** *выполнения* данного *условия*.
...
* Условное выражение смешанного типа
