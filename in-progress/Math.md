...
«Монетку подбрасывают 5 раз. Сколько возможно исходов?»

Ответ: 10.

Объяснение: у монетки две стороны (орёл и решка) - 2 возможных исхода при одном бросании. Бросаем 5 раз: 2 + 2 + 2 + 2 + 2 = 10.
