...
Объяснение: у монетки две стороны (орёл и решка) - 2 возможных исхода при одном подбрасывании. Используем правило произведения: 2 * 2 * 2 * 2 * 2 = 32. Почему используется правило произведения, а не суммы?
