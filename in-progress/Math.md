...
*Множество* `A` называют **подмножеством множества** `B`, если *все элементы множества* `A` являются также и *элементами множества* `B`. Говорят, что множество `A` **содержится** в множестве `B`, множество `B` **содержит** множество `A`. Обозначение: `A ⊆ B`. 
