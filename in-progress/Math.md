...
Стоит отметить, что сам класс объектов не важен для формирования комбинаторной задачи. В задаче #1 (как и в любой последующей) вместо карандашей в коробке могли быть карты в колоде, бочонки для лото в мешочке и так далее.

Стоит усвоить принцип - тогда можно его применять повсеместно. 
