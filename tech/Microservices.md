...
**Слабая связанность** (англ. `low coupling`) - сервисы должны иметь минимальные зависимости друг от друга, чтобы снизить влияние изменений.
...
Предпочитайте асинхронный обмен сообщениями для межсервисного взаимодействия, чтобы улучшить масштабируемость и устойчивость.
