...
## Об озере данных (`Data Warehouse`)

**Озером данных** (англ. `Data Lake`) называют репозиторий, в котором *хранятся огромные объемы сырых данных* (англ. `vast pool of raw data`) в их *первоначальном*, *неотформатированном виде* до тех пор, *пока они не будут использованы*. 
